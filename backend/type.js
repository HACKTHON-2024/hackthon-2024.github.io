...
const createjobs=z.object({
  ...
  // Zod schema for landowner profile update
  const updateLandownerProfile = z.object({
    username: z.string(),
    gender: z.string(),
    DOB: z.date(),
    aadhaar_ID: z.string().length(12, "Aadhaar ID must be exactly 12 digits"),
  ...
  .string()
  .length(10, "Alternate mobile number must be exactly 10 digits")
  .optional()
  .nullable(),
...
const updateLabourProfile=z.object({
    username: z.string(),
    gender: z.string(),
    DOB: z.date(),
    aadhaar_ID: z.string().length(12, "Aadhaar ID must be exactly 12 digits"),
